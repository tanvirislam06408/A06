...
const Start = () => {
    return (
        <div className='flex px-6 transition-all duration-150 hover:-translate-y-1  flex-col shadow-xs justify-center items-center text-center space-y-3 border-2 rounded-2xl border-gray-200'>
