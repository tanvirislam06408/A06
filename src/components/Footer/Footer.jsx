...
const Footer = () => {
  return (
    <div className="bg-[#101727]">
      <footer className="footer sm:footer-horizontal  text-white p-10 container mx-auto border-b border-gray-500">
        <div>
      ...
      <div className='text-white container mx-auto flex justify-between items-center py-5 flex-wrap'>
        ...
        <div>
          <ul className='flex items-center gap-4'>
            <li className='text-[16px] text-gray-500'>Privacy Policy</li>
            <li className='text-[16px] text-gray-500'>Terms of Service</li>
            <li className='text-[16px] text-gray-500'>Cookies</li>
          </ul>
        </div>
      </div>
    </div>
